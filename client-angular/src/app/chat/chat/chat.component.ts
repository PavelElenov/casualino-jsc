...
export class ChatComponent implements OnDestroy {
  ...
  dropDownSelectedValue: string | undefined;
  ...
  users: IUser[] = [
    ...
    },
    {
      ...
      level: 30,
      img: 'https://img.freepik.com/premium-vector/businessman-profile-cartoon_18591-58479.jpg?w=2000',
    },
    {
      username: 'Ivo',
      email: 'ivo@gmail.com',
  ...
  trackByIndex(index: number, option: IUser){
    return option.email;
  }
  ...
  changeSelectedElementHandler(value: User) {
    console.log(value);
